...
//TODO Add instance variables (Hint: you only need 2!)
    private double ResistorNumber;
    private double VoltageNumber;
...
//FIX THIS so that it returns the actual voltage
    VoltageNumber = CurrentNumber * ResistorNumber;
...
//is between 50 and -50, otherwise print an error message.
    if(voltage>= 50 && voltage <= 50){
        VoltageNumber = voltage; 
    }else{
        System.out.println("Error: Value is not in the set parameters");
    }
CurrentNumber = (VoltageNumber/ResistorNumber);
    }
    /**
...
//FIX THIS
PowerNumber = CurrentNumber * VoltageNumber;
        return PowerNumber;
    }
